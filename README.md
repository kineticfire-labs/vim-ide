...
| jj | no | no | Select first autocomplete option |
...
# License
- The vim-ide project is released under [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) and includes code under [MIT License](https://opensource.org/licenses/MIT) as described in the NOTICE.
